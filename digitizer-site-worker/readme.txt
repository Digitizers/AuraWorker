...
4. The Updates tab for a connected site in Aura — SiteAgent rollout control (release channel, policy, risk state), pending plugin/theme updates with one-click Update / Update All, and database migration status.
